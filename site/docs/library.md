...
Hard-coding `http://127.0.0.1:11434` treats Ollama like a local daemon. ollanet discovers hosts you configure or select. A reachable host is not a trusted host.
